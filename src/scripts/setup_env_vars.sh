...
then
  ...
  CLOUDSMITH_PYTHON_DOWNLOAD_REPOSITORY_URL="https://packages.ft.com/basic/$CLOUDSMITH_REPOSITORY_IDENTIFIER/python/simple/"
  ...
  echo "export CLOUDSMITH_PYTHON_DOWNLOAD_REPOSITORY_URL=\"$CLOUDSMITH_PYTHON_DOWNLOAD_REPOSITORY_URL\"" >> "$BASH_ENV"
  ...
  echo "CLOUDSMITH_PYTHON_DOWNLOAD_REPOSITORY_URL=$CLOUDSMITH_PYTHON_DOWNLOAD_REPOSITORY_URL"
  echo "CLOUDSMITH_REPOSITORY_IDENTIFIER=$CLOUDSMITH_REPOSITORY_IDENTIFIER"
  echo "CLOUDSMITH_SERVICE_IDENTIFIER=$CLOUDSMITH_SERVICE_IDENTIFIER"
fi
